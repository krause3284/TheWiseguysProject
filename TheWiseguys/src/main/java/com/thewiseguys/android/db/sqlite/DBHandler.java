...
public class DBHandler extends SQLiteOpenHelper {
    ...
    // Database Name
    private static final String DATABASE_NAME = "thewiseguys";
     ...
     * */
    public void addUser(String name, String email, String unique_id, String created_on) {
        SQLiteDatabase db = this.getWritableDatabase();

        ContentValues values = new ContentValues();
        values.put(KEY_NAME, name); // Name
        values.put(KEY_EMAIL, email); // Email
        values.put(KEY_UID, unique_id); // Email
        values.put(KEY_CREATED_ON, created_on); // Created At
    ...
    public HashMap<String, String> getUserDetails(){
        ...
        if(cursor.getCount() > 0){
            ...
            user.put("created_on", cursor.getString(4));
        }
        cursor.close();
        db.close();
        // return user
